gameData.ELEMENTS[gameData.FAMILIES.research][gameData.RACES.tomatoes.id] = {
	bastardsword: {
		...
		timeConstruction: 15,
		needs: [{t: gameData.RESOURCES.water.id, value: 100}, {t: gameData.RESOURCES.wood.id, value: 80}],
		g: 'bastardsword',
		addPassiveSkills: [],
	...
	longbow: {
		...
		timeConstruction: 20,
		needs: [{t: gameData.RESOURCES.water.id, value: 100}, {t: gameData.RESOURCES.wood.id, value: 200}],
		g: 'longbow',
		addPassiveSkills: [],
	...
	spikedmace: {
		...
		timeConstruction: 20,
		needs: [{t: gameData.RESOURCES.water.id, value: 250}, {t: gameData.RESOURCES.wood.id, value: 200}, {t: 'factory'}],
		g: 'spikedmace',
		addPassiveSkills: [],
