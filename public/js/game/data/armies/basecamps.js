...
gameData.BASECAMPS[gameData.RACES.tomatoes.id] = {
		buildings : [gameData.ELEMENTS[gameData.FAMILIES.building][gameData.RACES.tomatoes.id].mothertree],
...
gameData.BASECAMPS[gameData.RACES.lemons.id] = {
		buildings : [gameData.ELEMENTS[gameData.FAMILIES.building][gameData.RACES.lemons.id].mothertree],
