...
gameSurface.init = function () {
	...
	function render() {
		...
		gameSurface.goldSurface.animate(clockDelta);
...
gameSurface.createScene = function () {
    ...
    this.goldSurface = new WaterSurface(3000,3000, 2, waterTexture, waterTexture2);
	this.goldSurface.model.position.x = gameContent.map.size.x * this.PIXEL_BY_NODE / 2 - 5;
    this.goldSurface.model.position.y = gameContent.map.size.y * this.PIXEL_BY_NODE / 2;
    this.goldSurface.model.position.z = -20;
    scene.add(this.goldSurface.model);
